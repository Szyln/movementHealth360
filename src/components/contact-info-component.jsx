...
function ContactInfoComponent({ fontSizeClasses }) {
  return (
    <ul>
      ...
      <ContactInfoItemComponent hrefType="mailto" bsIconName="envelope-fill" fontSizeClasses={fontSizeClasses}>movementhealth360[at]gmail.com</ContactInfoItemComponent>
    </ul>
  );
}
